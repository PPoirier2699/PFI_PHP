...
if($objectType == "comment") {
    ...
    <div class="comment">
      ...
      <div style="margin-left:5%;">
        <?php if(validate_session() && $value["authorID"] == $_SESSION["userID"]) {?>				      
          <button value="<?php echo $value['id']?>" onClick="edit_button_click(this, 'comment');" type="button" class="btn"><u>Edit</u> </button>
          <button onClick="deleteFunc(<?php echo $value['id']?>, 'comment');" type="button" class="btn"><u>Delete</u> </button>
        <?php } ?>
    ...
    ?>
    <button class="btn" onClick="load_more_comment();" style="background-color:white;width:70%; margin:0 15%;">More Comment</button></div>
    <?php
}
?>
